...
// Nút nhấn (GPIO34): lưu ý GPIO34 là input-only và KHÔNG có internal pull-up/down
#define BUTTON_PIN 34
#define BUTTON_ACTIVE_LOW 1    // 1 nếu nút kéo xuống GND khi nhấn (cần external pull-up)
...
void startChieuCaoManual()
{
    if (trangThaiCC != CC_DANG_DO && !inCountdownScreen)
    {
        ...
        Serial.println("Manual start: Do Chieu Cao");
    }
}
