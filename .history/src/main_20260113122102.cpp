...
#define BUTTON_ACTIVE_LOW 1    // 1 nếu nút kéo xuống GND khi nhấn (sử dụng INPUT_PULLUP)
...
// Button (GPIO27 — using internal pull-up)
pinMode(BUTTON_PIN, INPUT_PULLUP);
lastButtonReading = digitalRead(BUTTON_PIN);
buttonState = lastButtonReading;
Serial.println("Button on GPIO27 configured as INPUT_PULLUP");
