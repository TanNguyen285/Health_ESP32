...
// Manual mode khi nhấn nút để ép đo chiều cao ngay cả khi cảm biến chưa phát hiện 'người'
...
void capNhatChieuCao()
{
    ...
    switch (trangThaiCC)
    {
        ...
        case CC_DANG_DO:
        {
            ...
            // Hiển thị khác khi bắt nguồn từ nút
            showCountdownScreen(manualChieuCaoMode ? "Do Chieu Cao (BTN)" : "Do Chieu Cao", conLai);

            // Chỉ cộng mẫu hợp lệ (cho phép mọi mẫu hợp lệ khi nhấn nút)
...
// Button (GPIO34 is input-only — ensure external pull-up or appropriate wiring)
